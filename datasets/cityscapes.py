...
class Cityscapes(data.Dataset):
    ...
    **Parameters:**
    ...
    CityscapesClass = namedtuple('CityscapesClass', ['name', 'id', 'train_id', 'train_id_16', 'category', 'category_id',
    ...
    classes = [
        ...
        CityscapesClass('road',                 7, 0, 0, 'flat', 1, False, False, (128, 64, 128)),
        CityscapesClass('sidewalk',             8, 1, 1, 'flat', 1, False, False, (244, 35, 232)),
        ...
        CityscapesClass('building',             11, 2, 2, 'construction', 2, False, False, (70, 70, 70)),
        CityscapesClass('wall',                 12, 3, 3, 'construction', 2, False, False, (102, 102, 156)),
        CityscapesClass('fence',                13, 4, 4, 'construction', 2, False, False, (190, 153, 153)),
        ...
        CityscapesClass('pole',                 17, 5, 5, 'object', 3, False, False, (153, 153, 153)),
        CityscapesClass('polegroup',            18, 255, 255, 'object', 3, False, True, (153, 153, 153)),
        CityscapesClass('traffic light',        19, 6, 6, 'object', 3, False, False, (250, 170, 30)),
        CityscapesClass('traffic sign',         20, 7, 7, 'object', 3, False, False, (220, 220, 0)),
        CityscapesClass('vegetation',           21, 8, 8, 'nature', 4, False, False, (107, 142, 35)),
        CityscapesClass('terrain',              22, 9, 255, 'nature', 4, False, False, (152, 251, 152)),
        CityscapesClass('sky',                  23, 10, 9, 'sky', 5, False, False, (70, 130, 180)),
        CityscapesClass('person',               24, 11, 10, 'human', 6, True, False, (220, 20, 60)),
        CityscapesClass('rider',                25, 12, 11, 'human', 6, True, False, (255, 0, 0)),
        CityscapesClass('car',                  26, 13, 12, 'vehicle', 7, True, False, (0, 0, 142)),
        CityscapesClass('truck',                27, 14, 255, 'vehicle', 7, True, False, (0, 0, 70)),
        CityscapesClass('bus',                  28, 15, 13, 'vehicle', 7, True, False, (0, 60, 100)),
        ...
        CityscapesClass('motorcycle',           32, 17, 14, 'vehicle', 7, True, False, (0, 0, 230)),
        CityscapesClass('bicycle',              33, 18, 15, 'vehicle', 7, True, False, (119, 11, 32)),
    ...
    train_id_to_name = [c.name for c in classes if c.train_id !=255]
    train_id_to_name.append('a photo')
    ...
    def __init__(self, root,  dataset='cityscapes', split='train', mode='fine', target_type='semantic', transform=None, ACDC_sub = 'night'
        ...
        if self.dataset == 'ACDC':
            self.mode = 'gt'
        elif self.dataset == "NighttimeDrivingTest":
            self.mode = 'gtCoarse_daytime_trainvaltest'
        else:    
            self.mode = 'gtFine'
        ...
        if self.dataset == 'ACDC':
            ...
            self.images_dir = os.path.join(self.root,'leftImg8bit', 'test')
        else:
        ...
        if self.dataset == 'ACDC':
            ...
            self.targets_dir = os.path.join(self.root, self.mode, 'test')
        else:
            ...
            for file_name in os.listdir(img_dir):
                ...
                if self.dataset == "ACDC":
                    ...
                    target_name = '{}_{}'.format(file_name.split('_leftImg8bit')[0],
                                             self._get_target_suffix("gtCoarse", self.target_type))
